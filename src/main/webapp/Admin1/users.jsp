...
if(request.getAttribute("x")==null){
	...
	request.getRequestDispatcher("../ContUser?int=1").forward(request, response);
} %>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Reservation <a href="newUser.jsp" type="button" class="btn btn-sm btn-primary">Add New user</a></div>
					<div class="panel-body">
						<table id="example" class="table table-striped table-hover table-bordered" style="width:100%">
							...
							<tbody>
                                ...
                                <c:forEach items="${modele.users}" var="p">
								<tr>
									...
									<td>${p.gender}</td>
                                     ...
                                     <td>
                                     <a href="editUser.jsp?cne=${p.cne}" > <button class="btn btn-success btn-sm"><i class="fa fa-edit"></i></button></a>
                                    <a onclick="return confirm('Etes-vous sûr ?')" href="../ContUser?action=s&cne=${p.cne }"  > <button class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button></a>
                                    </td>
