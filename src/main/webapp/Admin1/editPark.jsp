...
if(request.getParameter("id")!=null) {
	ParkImplDao p=new ParkImplDao();
	

	Park l = p.getPark(Integer.parseInt(request.getParameter("id")));
...
%>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-default">
			<div class="panel-heading">Park Modify</div>
			<div class="panel-body">

				<div class="col-md-12">

					<form action="../ContPark?f=1" method="POST">
						...
						<div class="form-group">
							<label>Park Adesse</label>
							<input type="text" class="form-control" placeholder="Enter Here.." id="ownername" name="adresse" value="${livre.adresse}" required>
						</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Tesla" id="vehcomp" name="nplace"  value="${livre.nplace}" required>
						</div>
