		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="col-md-12">
					...
					<form action="../ContUser?f=2" method="POST">

						

						<div class="form-group">
							<label>Cne </label>
							<input type="text" class="form-control" placeholder="Cne" id="vehreno" name="cne"  >
						</div>


						<div class="form-group">
							<label>NOm</label>
							<input type="text" class="form-control" placeholder="Nom" id="vehcomp" name="nom"  required>
						</div>
						...
						<div class="form-group">
							<label>Prenom</label>
							<input type="text" class="form-control" placeholder="Prenom" id="ownername" name="prenom"  required>
						</div>


						<div class="form-group">
							<label>email</label>
							<input type="email" class="form-control" placeholder="Email"  id="ownercontno" name="email"  required>
						</div>
                         <div class="form-group">
							<label>Telephone</label>
							<input type="text" class="form-control" placeholder="telephone" id="vehcomp" name="telephone"   required>
						</div>
						<div class="form-group">
							<label>Adresse</label>
							<input type="text" class="form-control" placeholder="adresse" id="vehcomp" name="adresse"   required>
						</div>
						<div class="form-group">
							<label>Solde</label>
							<input type="text" class="form-control" placeholder="adresse" id="vehcomp" name="solde"   required>
						</div>
						
						<div class="form-group">
							<label>Mot de pass</label>
							<input type="password" class="form-control" placeholder="mot De pass" id="vehcomp" name="motpass"   required>
						</div>
						<div class="form-group">
							<label>Genre</label>
							<select class="form-control" name="gender" id="catename" >
