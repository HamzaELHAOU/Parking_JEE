	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Manage Park</li>
			</ol>
		</div>
		<!--/.row-->
		...
		<div class="panel panel-default">
			<div class="panel-heading">New Park</div>
			<div class="panel-body">

				<div class="col-md-12">

					<form action="../ContPark?f=2" method="POST">

						

						<div class="form-group">
							<label>Park Name</label>
							<input type="text" class="form-control" placeholder="Park" id="vehcomp" name="nom" required>
						</div>
						...
						<div class="form-group">
							<label>Park adresse</label>
							<input type="text" class="form-control" placeholder="place" id="ownername" name="adresse"  required>
						</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Tesla" id="vehcomp" name="nplace"   required>
						</div>
