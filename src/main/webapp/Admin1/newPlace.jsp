		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="col-md-12">
					...
					<form action="../ContPlace?f=2" method="POST">
						...
						<div class="form-group">
   						...
   						<div class="form-group">
							...
							<select class="form-control" name="idPark" id="catename" >
							 
								<option value="null">Select Park</option>
								<% ParkImplDao pd= new ParkImplDao();
                                  List<Park> lists = pd.getAll(); 
   						        for(Park a:lists) { %>
						...
						<div class="form-group">
							<label>Etat De Place</label>
							<select class="form-control" name="etat" id="catename" >
							 
								<option value="null"> Choisir l'etat</option>
