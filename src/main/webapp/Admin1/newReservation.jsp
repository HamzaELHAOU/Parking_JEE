		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="col-md-12">
					...
					<form action="../controleur?f=2" method="POST">

						

						<div class="form-group">
							<label>Park Name</label>
							<input type="text" class="form-control" placeholder="Park" id="vehcomp" name="park" required>
						</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="place" id="ownername" name="place"  required>
						</div>


						<div class="form-group">
							<label>Heurest</label>
							<input type="text" class="form-control" placeholder="Enter Here.."  id="ownercontno" name="heures"  required>
						</div>
                         <div class="form-group">
							<label>Date debut</label>
							<input type="date" class="form-control" placeholder="Tesla" id="vehcomp" name="debut"  required>
						</div>
						<div class="form-group">
							<label>Debut Fin</label>
							<input type="date" class="form-control" placeholder="Tesla" id="vehcomp" name="fin"   required>
						</div>
						
						<div class="form-group">
							<label>Prix</label>
							<input type="text" class="form-control" placeholder="Tesla" id="vehcomp" name="prix"   required>
						</div>
