...
if(request.getAttribute("x")==null){
	...
	request.getRequestDispatcher("../ContPark?int=1").forward(request, response);
} %>
	...
	<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="./dashboard.jspl"><span>Vechicle </span>Parking System</a>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"> <a href="parks.jsp"><em class="fa fa-th-large">&nbsp;</em> Parks</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Parks Management</li>
			</ol>
		</div>
		<!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Parks <a href="newPark.jsp" type="button" class="btn btn-sm btn-primary">Add New Parking</a></div>
					<div class="panel-body">
						<table id="example" class="table table-striped table-hover table-bordered" style="width:100%">
							...
							<tbody>
                                ...
                                <c:forEach items="${modele.parks}" var="p">
								<tr>
									...
									<td>${p.nplace}</td>
                                     ...
                                     <td>
                                     <a href="editPark.jsp?id=${p.id }" > <button class="btn btn-success btn-sm"><i class="fa fa-edit"></i></button></a>
                                    <a onclick="return confirm('Etes-vous sûr ?')" href="../ContPark?action=s&id=${p.id }"  > <button class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button></a>
                                    </td>
