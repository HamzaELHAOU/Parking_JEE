		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Reservation <a href="newReservation.jsp" type="button" class="btn btn-sm btn-primary">Add New Reservation</a></div>
					<div class="panel-body">
						<table id="example" class="table table-striped table-hover table-bordered" style="width:100%">
							...
							<tbody>
                                ...
                                <c:forEach items="${modele.resers}" var="p">
								<tr>
									...
									<td>${p.prix}</td>
                                     ...
                                     <td>
                                    <a onclick="return confirm('Etes-vous sûr ?')" href="../controleur?action=s&id=${p.id }"  > <button class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button></a>
                                    </td>
