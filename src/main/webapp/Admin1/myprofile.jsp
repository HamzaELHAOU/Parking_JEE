<%@page import="Admin.Controler.Admin"%>
...
//Admin d = (Admin)session.getAttribute("admin");
//request.setAttribute("admin", d);}
// else{Admin d = new Admin("a","a","a","a","a");request.setAttribute("admin", d);}
Admin d =Login1.getAdminById(1);
request.setAttribute("admin", d);
%>
		...
		<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="col-md-12">
							...
							<form action="../Login?m=1"  method="POST">
                                ...
                                <div class="col-lg-6">
									...
									<input type="text" class="form-control"  id="adminname" name="fullName"  value="${admin.getFullName()}" required>
								</div>
                                </div>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control"  id="username" name="username" value="${admin.userName}"  required="required">
								</div>
                                </div>
								...
								<div class="form-group">
									<label>Email</label>
									<input type="email" class="form-control" value="${admin.email}" name="email" required="required">
								</div>
                                </div>
                                ...
                                <div class="form-group">
									...
									<input  class="form-control" name="telephone" type="tel" value="${admin.telephone}" required="true">
								</div>
                                </div>
                                <input  name="id" type="hidden" value="${admin.id}">

                                    <center> <button type="submit" class="btn btn-info" name="submit-profile">Make Changes</button> </center>
